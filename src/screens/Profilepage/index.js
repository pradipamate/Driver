...
export default class ProfilePage extends Component {
    ...
    fetch('https://online-edu.in/users/api/staff/' + uid, {
      ...
      .then((response) => {
        ...
        this.setState({
          ...
          subdepartment_name: response.subdepartment_name,
        });
  ...
  onUpload = async () => {
    ...
    try {
      ...
      FData.append("photo",res.uri)
      axios.patch("https://online-edu.in/users/api/staff/77/",FData,{headers:headers}).then((resonse)=>{
    ...
    return (
      <Container>
        ...
        <View>
          <ImageBackground
            ...
            <Card
              ...
              <CardItem
                ...
                <Text
                  style={{color: '#fff', fontSize: 15, marginVertical: '2%'}}>
                  {this.state.school_name}
                </Text>
                <Text
                  style={{color: '#fff', fontSize: 15, marginVertical: '2%'}}>
                  {this.state.subdepartment_name}
                </Text>
                {/* <Text style={{color:'#fff',fontSize:15,marginVertical:'2%'}}>Year 2018- 2020</Text> */}
                <Text
                  style={{color: '#fff', fontSize: 15, marginVertical: '2%'}}>
                  Birth Date:{this.state.date_of_birth}
                </Text>
                <Text
                  style={{color: '#fff', fontSize: 15, marginVertical: '2%'}}>
                  {this.state.address}
          ...
          {/* <TouchableOpacity style={{height:'8%',width:'60%',backgroundColor:'#171560',marginTop:'60%',marginHorizontal:'20%',borderRadius:30,flexDirection:'row',alignContent:'center'}}
                        onPress={() => this.props.navigation.navigate('RequestPage')}>
                        <Text  style={{color:'#fff',marginVertical:'4%',marginHorizontal:'22%',fontWeight:'bold',fontSize:20}}>Raise Request</Text>
                    </TouchableOpacity> */}
          <TouchableOpacity
            style={{
              height: '8%',
