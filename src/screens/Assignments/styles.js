...
export default {
  ...
  cardLeft4: { fontWeight: 'bold', color: '#999', marginTop: '1%', width: '100%' },
  cardLeft5: { fontWeight: 'bold', color: '#3498DB', marginTop: '1%', width: '100%' },

  cardLeft: { fontWeight: 'bold', color: '#333', marginTop: '1%', width: '100%' },
  cardLeft2: { fontWeight: 'bold', color: '#3498DB', marginTop: '1%', width: '100%',fontSize: 22 },
