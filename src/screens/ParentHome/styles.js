...
export default {
  ...
  cardItem: { backgroundColor: '#fff',borderRadius:20 },
   cardLeft4: { fontWeight: 'bold', color: '#656566', marginTop: '1%', width: '100%' },

  cardLeft: { fontWeight: 'bold', color: 'red', marginTop: '1%', width: '100%' },
  cardLeft1: { fontWeight: 'bold', color: 'green', marginTop: '1%', width: '100%' },

   cardLeft2: { fontWeight: 'bold', color: '#171560', marginTop: '1%', width: '100%',fontSize: 22 },
