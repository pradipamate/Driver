...
export default class AssignmentDue extends Component {
    constructor(props) {
                    ...
                    <Card >
                        ...
                        <CardItem style={styles.cardItem}>
                            ...
                            <Right style={{ flexDirection: 'column' }}>
                                ...
                                <Text style={styles.cardLeft4}>Due Date :<Text style={{color:'#EB7F70'}}>{item.duedate}</Text></Text>
                        ...
                        <CardItem style={{ backgroundColor: '#fff' }}>
                            ...
                            <>
                                <Button style={{ width: '50%', backgroundColor: '#EB7F70', borderRadius: 45, marginRight: '3%' }}
                                   >
        ...
        return (
            <Container>
                <Header  style={{ borderBottomWidth: 0.4 ,backgroundColor:'#EB7F70'}}>
                    ...
                    <Body>
                        <Title style={{ color: '#fff' }}>Assignment Due</Title>
                    </Body>
                   
                </Header>
                <TouchableOpacity style={{height:'8%',backgroundColor:'#EB7F70',marginVertical:'5%',marginTop:'8%',marginHorizontal:'5%',borderRadius:8,flexDirection:'row',alignContent:'center'}}
                        >
                        <Text  style={{marginRight:'5%',color:'#fff',marginVertical:'4%',marginHorizontal:'10%',fontWeight:'bold',fontSize:20}}>
                        Assignment Due</Text>
                    </TouchableOpacity>
                <FlatList
